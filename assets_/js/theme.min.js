...
function getCartValue(){
   let totalCartValue = 0;
    ...
    console.log("I didn't add number")
}
...
let grid = document.getElementsByClassName("gridBtn");
    let list = document.getElementsByClassName("listBtn");
    let itemRow = document.getElementById("itemRow");
    let itemRowC = document.getElementsByClassName("itemRow");
function switchViewGrid() {

    for(let i = 0; i < grid.length; i++){
        let element = grid[i];
            console.log(element, itemRow)

            for(let i = 0; i < itemRowC.length; i++){
                let elementc = itemRowC[i];
                elementc.classList.remove("item-list");
...
function switchViewList() {
    ...
    for(let i = 0; i < list.length; i++){
        let element = list[i];
            ...
            for(let i = 0; i < itemRowC.length; i++){
                let elementc = itemRowC[i];
                elementc.classList.add("item-list");
                console.log("remove working")
            }
    }
